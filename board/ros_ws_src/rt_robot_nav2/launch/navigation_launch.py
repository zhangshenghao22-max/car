...
def generate_launch_description():
    ...
    # REMOVED cmd_vel remapping - obstacle_avoidance is disabled in navigation mode
    # Nav2 controller_server now publishes directly to /cmd_vel (chassis input)
    # Nav2's local_costmap + DWB controller handles obstacle avoidance
    remappings = [('/tf', 'tf'),
                  ('/tf_static', 'tf_static')]  # No cmd_vel remapping needed
