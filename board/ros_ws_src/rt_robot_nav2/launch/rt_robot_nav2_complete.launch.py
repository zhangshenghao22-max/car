...
from launch.substitutions import EnvironmentVariable, LaunchConfiguration, PythonExpression, PathJoinSubstitution, TextSubstitution
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('use_odom_fusion', default_value='false',
                            description='Enable odometry fusion (disabled by default when F103 publishes /odom)'),
        ...
        DeclareLaunchArgument('use_auto_mapping', default_value='false',
                            description='Enable autonomous forward mapping driver in SLAM mode'),
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'open_rviz': PythonExpression([
                    "'true' if '", open_rviz, "'.lower() in ['true', '1', 'yes'] and '",
                    use_nav, "'.lower() not in ['true', '1', 'yes'] else 'false'"
                ]),
            }.items()
        ),
        ...
        Node(
            ...
            condition=IfCondition(PythonExpression([
                "'", open_rviz, "' == \"true\" and '", use_nav, "' == \"true\" and '",
