...
def generate_launch_description():
    ...
    map_file = 'rt_robot_map.yaml'  # Default map file
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='map_server',
            output='screen',
            parameters=[configured_params],  # Override yaml_filename to ensure it's passed correctly
            remappings=remappings),

        # AMCL node - initial pose is set via parameters in rt_robot_params.yaml (following mature project practices)
        Node(
            package='nav2_amcl',
            executable='amcl',
            name='amcl',
