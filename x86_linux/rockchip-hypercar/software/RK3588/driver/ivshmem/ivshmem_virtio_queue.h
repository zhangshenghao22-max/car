...
rt_inline int virtq_need_event(rt_uint16_t event_idx, rt_uint16_t new_idx, rt_uint16_t old)
{
    return (rt_uint16_t)(new_idx - event_idx - 1) < (rt_uint16_t)(new_idx - old);
}
