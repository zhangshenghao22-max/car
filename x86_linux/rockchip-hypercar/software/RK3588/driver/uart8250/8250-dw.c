...
#define RT_SERIAL_CONFIG_RK3588           \
{                                          \
    BAUD_RATE_1500000, /* 115200 bits/s */ \
...
static rt_err_t dw8250_probe(struct rt_platform_device *pdev)
{
    ...
    struct serial_configure config = RT_SERIAL_CONFIG_RK3588;
...
INIT_SUBSYS_EXPORT(dw8250_drv_register);
