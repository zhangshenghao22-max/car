...
static rt_err_t sdio_dw_rk3288_set_iocfg(struct sdio_dw *sd, struct rt_mmcsd_io_cfg *ios)
{
    ...
    if (pdata->sample_clk && ios->timing <= MMCSD_TIMING_SD_HS)
    {
...
static const struct rt_ofw_node_id sdio_dw_rockchip_ofw_ids[] =
{
    ...
    { .compatible = "rockchip,rk3568-dw-mshc", .data = &rk3288_drv_data },
    { .compatible = "rockchip,rk3588-dw-mshc", .data = &rk3288_drv_data },
    { /* sentinel */ }
};
...
INIT_DEVICE_EXPORT(sdio_dw_rockchip_drv_register);
