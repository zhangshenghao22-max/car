...
#define RT_LWIP_IPADDR "10.10.10.30"
...
#define RTT_UCLIENT_PLATFORM_RTTHREAD
#define RTT_URCLC_PLATFORM_RTTHREAD

/* Include examples */

/* end of Include examples */
...
#define MICRO_ROS_UDP_IP "10.10.10.31"
#define MICRO_ROS_UDP_PORT "8888"
/* end of udp configuration */
/* end of ROS node communication mode */
...
#define RT_USING_DRIVER_IVSHMEM
#define RT_USING_IVSHMEM_NET
